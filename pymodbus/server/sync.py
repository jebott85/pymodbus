...
# Creation Factories
# --------------------------------------------------------------------------- #
def StartTcpServer(context=None, identity=None, address=None, defer_serve_forever=False, **kwargs):
    ...
    :param defer_serve_forever: True/False defer running server.serve_forever() and return
    ModbusTcpServer(), serve_forever() to be explicitly started by user.
    """
    framer = kwargs.pop("framer", ModbusSocketFramer)
    server = ModbusTcpServer(context, framer, identity, address, **kwargs)

    if not defer_serve_forever:
